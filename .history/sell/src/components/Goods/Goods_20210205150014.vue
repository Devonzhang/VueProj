<template>
  <div class="goods">
    ...
    <div class="menu-wrapper" ref="menuScroll">
      <ul>
        ...
        <li class="menu-item" v-for="(item,index) in goods" :class="{'current':currentIndex===index +1 }"  @click="selectMenu(index+1)">
          ...
          <i class="num" v-show="calculateCount(item.spus)"></i>
    ...
    <Shopcart :shipping_fee_tip="poiInfo.shipping_fee_tip" :min_price_tip="poiInfo.min_price_tip" :selectFoods="selectFoods">
